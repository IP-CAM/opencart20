...
/**
 * Class ModelSmart2payPaymentExtension
 *
 * @property DB $db
...
class ModelSmart2payPaymentExtension extends Model
{
    ...
    public function install()
    {
        ...
        ');
        $this->db->query('
            INSERT INTO `' . DB_PREFIX . 'smart2pay_country_method` (`country_id`, `method_id`, `priority`) VALUES
                (1,76,99),
                (2,13,1),
                (2,14,2),
                (2,76,99),
        ...
        foreach( $this->model_smart2pay_helper->get_main_module_fields() as $name => $setting )
            $settings[$name] = $setting['value'];

        $this->model_smart2pay_helper->save_module_settings( $settings );
