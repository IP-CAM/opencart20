...
class ControllerPaymentSmart2payTransferenciabradesco extends ControllerPaymentSmart2payAbstract
{
    /**
    ...
    {
        return 'Transferencia entre Contas Bradesco';
    }
