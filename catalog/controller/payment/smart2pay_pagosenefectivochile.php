...
class ControllerPaymentSmart2payPagosenefectivochile extends ControllerPaymentSmart2payAbstract
{
    /**
    ...
    {
        return 'Pagos en efectivo Chile';
    }
